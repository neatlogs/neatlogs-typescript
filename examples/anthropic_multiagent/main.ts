...
const reviewerSys = new SystemPromptTemplate([{
  role: 'system',
...
const fixerSys = new SystemPromptTemplate([{
  role: 'system',
...
const testerSys = new SystemPromptTemplate([{
  role: 'system',
...
const documenterSys = new SystemPromptTemplate([{
  role: 'system',
